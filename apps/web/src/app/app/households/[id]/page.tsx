      ...
      <Card>
        <CardHeader>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              ...
              size="sm"
              leftIcon={<IconChart className="h-4 w-4" />}
              onClick={() => (window.location.href = `/app/households/${id}/financial-snapshot`)}
            >
              Financial snapshot
            </Button>
            <Button
            ...
            <Button
              ...
              size="sm"
              leftIcon={<IconChart className="h-4 w-4" />}
              onClick={() => (window.location.href = `/app/households/${id}/simulation`)}
            >
              What-if
            </Button>
          </div>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            ...
            <Badge tone="success">What-if</Badge>
            {UPCOMING_TABS.map((t) => (
